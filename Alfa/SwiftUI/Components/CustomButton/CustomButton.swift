...
/// This variable `title` is used to store a specific value in the application.
    var title: String
/// This variable `image` is used to store a specific value in the application.
    var image: Image?
/// This variable `buttonTapped` is used to store a specific value in the application.
...
/// This class `CustomButton_Previews` is used to manage specific logic in the application.
